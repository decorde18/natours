...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //add marker to each coordinate
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
              //update CurrentUser that we created the route and can view in postman, not update User. That is a different route
...
var stripe = Stripe('pk_test_51JRSJEJQR0Eec9WQjVgaIWVO3HhPLDHZgULcswXiLj5BOCsLEeUy9ANhlBVw1YcyFDOwDe8wK7rMNNvPae4tRIA000LbEeBflv');
...
if (userDataForm) //save settings button pushed
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); //Commented out below so because they were appended to form with above code rather than the previous way which allows us to save file uploads as well.
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; // updateData(name, email); //sends to updatesettings.js to run //before password update
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //js reads dashes and converts to camel tex ie tour-id becomes tourId  ALSO don't need dataset.tourId because the const is the same so destructuring with {}
